...
Claude Code、Codex、Cursor是进来最火的AI 编程工具，国内的Qoder、ZCode、CodeBuddy 等国内厂商的产品也在抢占市场，这些vibe coding 工具让行外人也能一句话生成一个作品，减轻程序员的工作压力，他们变得越来越火爆，以至于没用过他们就相当与“落伍”了
...
上述图中是Transformer 的 Block 结构，左边是**编码器Block**，右边是**解码器Block**，编码器和解码器堆叠*N就是Transformer结构
