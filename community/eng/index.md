...
Before opening a PR, read (or have your AI check against) [PR_requirement.md](./PR_requirement.md), and go through every item before you submit.
...
Fork, branch from `main`, write, open a PR. Go through the [PR requirements](./PR_requirement.md) before you submit.
