...
**A100**是NVIDIA为数据中心设计的纯计算GPU，没有图形输出能力。不能用来打游戏。
...
### 4.1  架构上的优化-TPU架构（Tensor Processing Unit）
...
### 4.5.2 FlashAttention 与 PagedAttention 的对比
